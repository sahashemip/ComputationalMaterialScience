...
if __name__ == '__main__':
    ...
    for i in range(first-1, last):
        ...
        print ""
        print "! %4i  freq: %10.5f  alpha: %10.7f  beta2: %10.7f  activity: %10.7f ra11: %10.5f  ra12: %10.5f  ra13: %10.5f  ra21: %10.5f  ra22: %10.5f  ra23: %10.5f  ra31: %10.5f  ra32: %10.5f  ra33: %10.5f " % (i+1, eigval, alpha, beta2, 45.0*alpha**2 + 7.0*beta2, ra[0][0], ra[0][1], ra[0][2], ra[1][0], ra[1][1], ra[1][2], ra[2][0], ra[2][1], ra[2][2])
        output_fh.write("%03i  %10.5f  %10.7f  %10.7f  %10.7f  %10.5f  %10.5f  %10.5f  %10.5f  %10.5f  %10.5f  %10.5f  %10.5f  %10.5f\n" % (i+1, eigval, alpha, beta2, 45.0*alpha**2 + 7.0*beta2, ra[0][0], ra[0][1], ra[0][2], ra[1][0], ra[1][1], ra[1][2], ra[2][0], ra[2][1], ra[2][2]))
        output_fh.flush()
    #
    output_fh.close()
